...
UA012 | UmbrellaModelStandards | Error | UmbrellaModelStandardsAnalyzer — model properties must use required; model interfaces, [UmbrellaInputModel] hierarchies, and properties with [UmbrellaAllowNonRequiredProperty] are excluded
UA013 | UmbrellaModelStandards | Error | UmbrellaModelStandardsAnalyzer — model properties must have a getter and use init; input models may use set, and [UmbrellaAllowMutableProperty] permits justified per-property mutation
