...
UA013 | UmbrellaModelStandards | Error | UmbrellaModelStandardsAnalyzer — public instance model properties must have a getter and use init when settable; input models, interface-required setters, and properties with [UmbrellaAllowMutableProperty] may use set
...
UA015 | UmbrellaModelStandards | Warning | UmbrellaModelStandardsAnalyzer — [UmbrellaInputModel] types declaring trimmable mutable strings must directly implement IUmbrellaTrimmable; technical mutation, [UmbrellaDoNotTrim], and concurrency stamps are excluded
