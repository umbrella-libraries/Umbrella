...
UWDI004 | DynamicImageGeneration | Warning | DynamicImageVersioningAnalyzer - Dynamic Image and file-image-preview usages with Razor variant-shaping values other than literals or enum members, including a runtime-bound EnableFocalPointSelection value, or non-static manually authored C# inputs, are omitted from generated catalogs regardless of whether URL fingerprinting is enabled
