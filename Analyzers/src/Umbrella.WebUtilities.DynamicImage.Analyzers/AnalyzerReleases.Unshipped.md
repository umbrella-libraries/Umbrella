...
UA018 | DynamicImageGeneration | Warning | DynamicImageVersioningAnalyzer - DynamicImage usages with non-static variant-shaping inputs reduce source-generated variant discovery and validation coverage
