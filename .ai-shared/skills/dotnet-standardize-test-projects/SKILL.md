...
```powershell
powershell -ExecutionPolicy Bypass -File {{skill_dir}}\dotnet-standardize-test-projects\scripts\Invoke-StandardizeTestProjects.ps1 -Mode Analyze
```

Apply changes:

```powershell
powershell -ExecutionPolicy Bypass -File {{skill_dir}}\dotnet-standardize-test-projects\scripts\Invoke-StandardizeTestProjects.ps1 -Mode Apply
```

Analyze another repo:

```powershell
powershell -ExecutionPolicy Bypass -File {{skill_dir}}\dotnet-standardize-test-projects\scripts\Invoke-StandardizeTestProjects.ps1 -Mode Analyze -RepoRoot "D:\ProjectsGIT\BOLE\ProjectBOLE-Kernel"
```
