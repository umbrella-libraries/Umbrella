...
if ([string]::IsNullOrWhiteSpace($ReportPath)) {
    $ReportPath = Join-Path -Path ([System.IO.Path]::GetTempPath()) -ChildPath 'dotnet-standardize-test-projects-report.json'
}
...
Write-Host "dotnet-standardize-test-projects mode: $Mode"
