---
name: umbrella-dotnet-blazor-client-ui-feature-agent
...
1. `.claude\skills\umbrella-dotnet-scaffold-client-data\SKILL.md`
2. `.claude\skills\umbrella-dotnet-scaffold-mapperly-factories\SKILL.md`
3. `.claude\skills\umbrella-blazor-scaffold-index-page\SKILL.md`
4. `.claude\skills\umbrella-blazor-scaffold-manage-page\SKILL.md`
5. `.claude\skills\umbrella-blazor-register-nav-item\SKILL.md`
