...
1. `.github\skills\dotnet-scaffold-client-data\SKILL.md`
2. `.github\skills\dotnet-scaffold-mapperly-factories\SKILL.md`
3. `.github\skills\blazor-scaffold-index-page\SKILL.md`
4. `.github\skills\blazor-scaffold-manage-page\SKILL.md`
5. `.github\skills\blazor-register-nav-item\SKILL.md`
