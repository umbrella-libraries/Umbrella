...
Read `.github\skills\umbrella-nuget-safe-upgrade\SKILL.md` for full instructions, inputs, and safety rules, then use `.github\skills\umbrella-nuget-safe-upgrade\scripts\Invoke-NuGetSafeUpgrade.ps1` to perform the upgrade.
