...
1. Use the `dotnet-add-ef-migration` agent or skill — do not run `dotnet ef migrations add` manually.
...
- Claude Code agent: `.claude\agents\dotnet-add-ef-migration.md`
- Copilot agent: `.github\agents\dotnet-add-ef-migration.agent.md`
