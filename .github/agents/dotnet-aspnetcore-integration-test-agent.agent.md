...
1. `.github\skills\dotnet-standardize-test-projects\SKILL.md`
2. `.github\skills\dotnet-scaffold-test-project\SKILL.md`
3. `.github\skills\dotnet-audit-aspnetcore-integration-test-readiness\SKILL.md`
4. `.github\skills\dotnet-scaffold-aspnetcore-integration-tests\SKILL.md`
