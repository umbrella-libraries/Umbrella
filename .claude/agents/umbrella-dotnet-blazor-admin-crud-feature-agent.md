---
name: umbrella-dotnet-blazor-admin-crud-feature-agent
...
2. `.claude\skills\umbrella-dotnet-scaffold-ef-repository\SKILL.md`
3. `.claude\skills\umbrella-dotnet-scaffold-api-server-models\SKILL.md`
4. `.claude\skills\umbrella-dotnet-scaffold-mapperly-factories\SKILL.md`
5. `.claude\skills\umbrella-dotnet-scaffold-api-data-service-controller\SKILL.md` or `.claude\skills\umbrella-dotnet-scaffold-api-repo-controller\SKILL.md`
6. `.claude\skills\umbrella-dotnet-scaffold-client-data\SKILL.md`
7. `.claude\skills\umbrella-dotnet-scaffold-auth-policy\SKILL.md`
8. `.claude\skills\umbrella-blazor-scaffold-index-page\SKILL.md`
9. `.claude\skills\umbrella-blazor-scaffold-manage-page\SKILL.md`
10. `.claude\skills\umbrella-blazor-register-nav-item\SKILL.md`
11. `.claude\skills\umbrella-dotnet-add-ef-migration\SKILL.md`
